...
# Source: https://help.ubuntu.com/community/SynapticsTouchpad/ShortcutKey
#
# tp_toggle
#
...
# The following line was updated from the source
tp_id=$(xinput list | grep -i touchpad | sed -nE 's/^.*id=(\S+).*$/\1/p')
